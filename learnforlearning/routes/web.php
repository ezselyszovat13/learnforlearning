...
Route::get('/personal/comment/', [UserController::class, 'personalComment'])->name('personal.user.comment')->middleware('auth');
Route::post('/subject/comment/update', [UserController::class, 'commentUpdate'])->name('user.comment.update')->middleware('auth');
Route::post('/personal/comment/update', [UserController::class, 'personalCommentUpdate'])->name('personal.comment.update')->middleware('auth');
